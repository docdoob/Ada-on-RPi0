...
--  This is the adapted from the Cortex A9 (ARMv7) version of this package
...
package System.BB.Parameters is
   ...
   Clock_Frequency : constant := 19_200_000;  -- unable to confirm whether
      --  true for RPi0
      --  Frequency of the CPU clock in Hz. We hard-code this here to allow
      --  static computation of the required prescaler.
   ...
   --  Number of interrupts supported by RPI2.  "BCM2835 ARM Peripherals"
   --  gives a different list.

   Trap_Vectors : constant := 8;
   ...
   --    5   (at 16#0014#) Unused
   --    6   (at 16#0018#) IRQ Trap (asynchronous)
   --    7   (at 16#001C#) FIQ Trap (asynchronous)
   ...
   --  Size of each of the interrupt stacks.   There is a
