# 20200804 added RPi0Base & RPi0 -- JMD
...
class Rpi0Base(CortexARTarget):
    ...
    @property
    def mcu(self):
       # this seems to work better than -march=armv6
        return 'ARM1176JZF-S'
    ...
    def __init__(self):
        super(Rpi0Base, self).__init__()

        self.add_linker_script('arm/rpi0/ram.ld', loader='RAM')
        self.add_gnat_sources(
            'src/i-raspberry_pi.ads',
            'src/s-macres__rpi2.adb')
        self.add_gnarl_sources(
            'src/a-intnam__rpi0.ads',
